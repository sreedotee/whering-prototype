...
const Icon = ({ d, size = 24, stroke = 2, fill = 'none' }) => (
...
function Thumb({ i = 0, ratio = '3/4', br = 'var(--r-sm)', children }) {
  return (
    <div style={{
...
function BrandBlock({ color = 'cyan', title, sub, icon, height = 140 }) {
  return (
...
Object.assign(window, { Icon, ICONS, SWATCHES, Thumb, BrandBlock });
